...
Summary: This Java program simulates basic stack operations based on user input. The user specifies the desired operations on the stack and the program executes and outputs the results of these operations.
*/
