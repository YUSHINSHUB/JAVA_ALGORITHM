...
//Summary: This Java program calculates the shortest path from a specified point to each cell in a grid using BFS. If a cell is not reachable, it outputs -1.

import java.io.*;
import java.util.*;

public class Q14940_Shortest_S1 {
