...
//This Java program reads a sequence of integers and for each query, it calculates the sum of a subsequence of the sequence and prints it. The program uses an optimized approach by computing the prefix sum of the entire sequence.

import java.io.*;

public class Q11659_Prefix_4_S3 {
