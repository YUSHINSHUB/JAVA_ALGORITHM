...
//This Java program solves the problem of finding the maximum total from top to bottom in
//a triangle of integers.
//It employs a bottom-up dynamic programming approach, calculating the maximum sums 
//row-by-row from the bottom of the triangle.
//The program handles single-row cases separately for efficiency and outputs the maximum 
//total to the standard output.
import java.io.*;
import java.math.*;
import java.util.*;

public class Q1932_Integer_Triangle_S1 {
